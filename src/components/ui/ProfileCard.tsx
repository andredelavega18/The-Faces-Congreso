...
// Inject keyframes removed - moved to globals.css
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div ref={shellRef} className="pc-card-shell relative z-[1] group">
                <section
                    className="pc-card grid relative overflow-hidden"
                    style={{
                        height: 'auto',
                        aspectRatio: '0.718',
                        borderRadius: cardRadius,
                        ...
                        boxShadow:
                            'rgba(0, 0, 0, 0.5) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) * 20px) - 6px) 20px -5px',
                ...
                >
                    <div
                        className="pc-inside absolute inset-0"
                        style={{
                    ...
                    >
                        {/* Shine layer */}
                        <div className="pc-shine pc-shine-anim" style={shineStyle} />
                        ...
                        {/* Avatar content */}
                        <div
                            className="pc-content pc-avatar-content overflow-visible"
                            style={{
                                mixBlendMode: 'normal',
                        ...
                        >
                            <div className="w-full absolute flex flex-col" style={{ top: '10%', display: 'flex', gridArea: 'auto' }}>
                                <h3
                                    className="font-bold m-0 px-2"
                                    style={{
                                ...
                                <p
                                    className="font-bold whitespace-nowrap mx-auto w-min"
                                    style={{
                                        position: 'relative',
                                        top: '-4px',
                                        fontSize: '14px',
