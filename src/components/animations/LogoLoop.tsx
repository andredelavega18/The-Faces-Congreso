        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              ...
              'grayscale transition-all duration-300 group-hover/item:grayscale-0 opacity-70 group-hover/item:opacity-100',
              'motion-reduce:transition-none',
              scaleOnHover &&
              'transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120'
            )}
            ...
            width={(item as any).width || 120}
            height={(item as any).height || 28}
            alt={(item as any).alt ?? ''}
